	...
	<div class="container jiangpin">
    	<ul>
            <foreach name="pro_data" item="vo">
                <li>
                    <a  target="_blank" href="<{:U('Wproduct/proinfo',array('id'=>$vo[id]))}>"><img src="__PUBLIC__/Uploads/Product/<{$vo.prophoto}>"/></a>
                    <h5><a target="_blank" href="<{:U('Wproduct/proinfo',array('id'=>$vo[id]))}>"><{$vo.proname}></a></h5>
                
                    
                    <p>微币：<span><{$vo.pro_weibi}></span></p>
                </li>
