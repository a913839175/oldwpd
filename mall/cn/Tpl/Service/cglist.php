    ...
    <div id="main" class="w1000">
        ...
        <div class="main_right fr">
        	<div class="right_title">
                ...
                <a href="javascript:void(0)"><{$proclassname}></a>
            </div>
            <div class="right_box">
                <foreach name="cglist_data" item="vo">
                    <div class="pro_box">
                        <div class="pro_pic">
                            <a href="<{:U('Service/classinfo',array('id'=>$vo[id]))}>" onclick="return false;"><img src="__PUBLIC__/Uploads/Product/<{$vo.prophoto}>" height="154" width="216" /></a>
                        </div>
                        <div class="pro_name">
                            <a href="<{:U('Service/classinfo',array('id'=>$vo[id]))}>"onclick="return false;"><{$vo.proname}></a>
                        </div>
                    </div>
                </foreach>
