    ...
    <head>
        <meta charset="utf-8">
            <title>微拍贷</title>
                ...
                <link rel="stylesheet" href="/mall/Public/Cn/css/bannerxq.css?v=20170919"/>
                </head>
                <script>
                ...
                <body>
                    ...
                    <div class="jifen_index" style="">
                        <div class="banner0727 banner2017091701"></div>
                        <div class="banner0727 banner2017091702"></div>
                        <div class="banner0727 banner2017091703">
                            <div class="conter">
                                <empty name="Think.session.k_user">
                                    <div class="Getthebutton top624">
                                        <a href="/?user&q=login" style="width:245px; height: 50px; display: block;"></a>
                                    </div>
                                    <else />
                                    <if condition="$yx==0">
                                        <div class="Getthebutton2 top624">
                                            <a href="__APP__/Act/midautumn2/id/1" style="width:245px; height: 50px; display: block;"></a>
                                        </div>
                                        <else/>
                                        <div class="Getthebutton3 top624">
                                            <a href="__APP__/Act/midautumn2/id/1" style="width:245px; height: 50px; display: block;"></a>
                                        </div>
                                        <p class="zhezhao top574"></p>
                                    </if>
                                </empty>
                                
                                <!-- 悦想包的遮罩  后面跟的class名字叫top574别忘记 -->
                                
                            </div>
                        </div>
                        <div class="banner0727 banner2017091704">
                            <div class="conter1">
                                 <empty name="Think.session.k_user">
                                <div class="Getthebutton top455">
                                     <a href="/?user&q=login" style="width:245px; height: 50px; display: block;"></a>
                                </div>
                                     <else />
                                    <if condition="$zx==0">
                                     <div class="Getthebutton2 top455">
                                            <a href="__APP__/Act/midautumn2/id/2" style="width:245px; height: 50px; display: block;"></a>
                                    </div>
                                        <else />
                                       <div class="Getthebutton3 top455">
                                            <a href="__APP__/Act/midautumn2/id/2" style="width:245px; height: 50px; display: block;"></a>
                                        </div>
                                        <p class="zhezhao top405"></p>
                                    </if> 
                                 </empty>
                                <!-- 尊享包的遮罩  后面跟的class名字叫top405别忘记 -->
                                 
                            </div>
                        </div>
                        <div class="banner0727 banner2017091705"></div>
                        <div class="banner0727 banner2017091706"></div>
                    </div>
