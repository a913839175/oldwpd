            ...
            <link rel="stylesheet" type="text/css" href="/mall/Public/Cn/css/index.css">
                ...
                <body>
                    ...
                    <div class="jifen_index" style="width: 100%;display: block;overflow: hidden;">
                        ...
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg01.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1111px;width: 1920px;"></p>
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg02.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 443px;width: 1920px;">
                            <a href="/index.php?user" style="width: 976px;height: 443px;display: block;margin: 0 auto;"></a>
                        </p>
                         <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg03.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 569px;width: 1920px;"> 
                         </p>
                          <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg04.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 417px;width: 1920px;"> 
                            <a href="/index.php?user" style="width: 976px;height: 417px;display: block;margin: 0 auto;"></a>
                         </p>
                          <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg05.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1823px;width: 1920px;"> 
                         </p>
                          <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg06.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1220px;width: 1920px;"> 
                            <a href="/index.php?user&q=shangchengindex" style="width: 976px;height: 1220px;display: block;margin: 0 auto;"></a>
                         </p>
                          <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg07.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 585px;width: 1920px;"> 
                         </p>
                         <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg08.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 219px;width: 1920px;"> 
                             <a href="/index.php?user" style="width: 976px;height: 219px;display: block;margin: 0 auto;"></a>
                         </p>
                          <p style="background: url(/mall/Public/Cn/images/bannerxq/bannerimg09.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1138px;width: 1920px;"> 
                         </p>
                    </div>
