    ...
    <head>
        <meta charset="utf-8">
            <title>微拍贷</title>
                ...
                <link rel="stylesheet" href="/mall/Public/Cn/css/bannerxq.css?v=20171130"/>
                </head>
                <script>
                ...
                <body>
                    ...
                    <div class="jifen_index" style="">
                        <div class="banner0727 banner120101">
                            <div class="banner120105_4">
                                <empty name="Think.session.k_user">
                                <a href="../?user&amp;q=login" class="banner120105_3">请登录查看</a>
                                </empty>
                            </div>
                        </div>
                        <empty name="Think.session.k_user">
                        <else />
                        <div class="banner120105">
                            <div class="banner120105midden">
                                <p class="banner120105_1">12月1日—12月31日：您本次共有<{$num}>个开奖码</p>
                                <if condition="$num!=0">
                                <p class="banner120105_2"><{$info}></p>
                                <else />
                                <img src="/mall/Public/Cn/images/bannerxq/2017120105.png" class="banner120105_5" />
                                </if>
                            </div>
                        </div>
                        </empty>
                        <div class="banner0727 banner120102"></div>
                        <div class="banner0727 banner120103"></div>
                        <div class="banner0727 banner120104"></div>
                    </div>
