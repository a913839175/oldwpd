            ...
            <link rel="stylesheet" type="text/css" href="/mall/Public/Cn/css/index.css">
                ...
                <body>
                    ...
                    <div class="jifen_index" style="width: 100%;display: block;overflow: hidden;">
                        ...
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner07070401.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 335px;width: 1920px;">
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner07070402.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 335px;width: 1920px;">
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner07070403.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 335px;width: 1920px;">
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner07070404.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 335px;width: 1920px;">
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner07070405.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 335px;width: 1920px;">
                        </div>
                    </div>
