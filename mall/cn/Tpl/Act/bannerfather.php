            ...
            <link rel="stylesheet" type="text/css" href="/mall/Public/Cn/css/index.css">
                ...
                <body>
                    ...
                    <div class="jifen_index" style="width: 100%;display: block;overflow: hidden;">
                        ...
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner053101.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 430px;width: 1920px;">
                        </div>
                        <div style="width: 100%;background: #f4eff0;overflow: hidden;clear: both;">
                            <div style="width: 1037px;background: #f4eff0;margin: 0 auto;">
                                <img src="/mall/Public/Cn/images/bannerxq/banner053102.jpg" alt="" />
                            </div>
                            <div style="width: 1037px;background: #f4eff0;margin: 0 auto;">
                                <img src="/mall/Public/Cn/images/bannerxq/banner053103.jpg" alt="" />
                            </div>
                            <div style="width: 1037px;background: #f4eff0;margin: 0 auto;">
                                <img src="/mall/Public/Cn/images/bannerxq/banner053104.jpg" alt="" />
                            </div>
                            <div style="width: 1037px;background: #f4eff0;margin: 0 auto;">
                                <img src="/mall/Public/Cn/images/bannerxq/banner053105.jpg" alt="" />
                            </div>
                            <div style="width: 1037px;background: #f4eff0;margin: 0 auto;">
                                <img src="/mall/Public/Cn/images/bannerxq/banner053106.jpg" alt="" />
                            </div>
                            <div style="width: 1037px;background: #f4eff0;margin: 0 auto;margin-bottom: 50px;">
                                <img src="/mall/Public/Cn/images/bannerxq/banner053107.jpg" alt="" />
                            </div>
                        </div>
                    </div>
