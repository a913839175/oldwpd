            ...
            <link rel="stylesheet" type="text/css" href="/mall/Public/Cn/css/index.css">
                ...
                <body>
                    ...
                    <div class="jifen_index" style="width: 100%;display: block;overflow: hidden;">
                        ...
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/banner020801.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 724px;width: 1920px;"></p>
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/banner020802.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1010px;width: 1920px;">
                            <a href="/tenderlistyear/index.html" target="_blank" style="width:1000px;height: 1010px;display: block;margin: 0 auto;"></a>
                        </p>
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/banner020803.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1725px;width: 1920px;">
                            <a href="/mall/index.php?m=index&a=index" target="_blank" style="width:1000px;height: 1725px;display: block;margin: 0 auto;"></a>
                        </p>
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/banner020804.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 1115px;width: 1920px;">
                            <a href="/mall/index.php?m=index&a=index" target="_blank" style="width:1000px;height: 1115px;display: block;margin: 0 auto;"></a>
                        </p>
                        <p style="background: url(/mall/Public/Cn/images/bannerxq/banner020805.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 198px;width: 1920px;"></p>
                    </div>
