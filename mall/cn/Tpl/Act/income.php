    ...
    <head>
        <meta charset="utf-8">
            ...
            <link rel="stylesheet" type="text/css" href="/mall/Public/Cn/css/index.css">
                ...
                <link rel="stylesheet" href="/mall/Public/Cn/css/bannerxq.css?v=20170727"/>
                </head>
                <script>
                ...
                <body>
                    ...
                    <div class="jifen_index" style="">
                        <div class="banner0727 banner082901"></div>
                        <div class="banner0727 banner082902"></div>
                        <div class="banner0727 banner082903"></div>
                        <div class="banner0727 banner082904"></div>
                        <div class="banner0727 banner082905"></div>
<!--                         <div class="banner0727 banner072703">
                            <div class="banner072704">
                                <empty name="Think.session.k_user">
                                    请登录
                                    <else />

                                    <p class="banner072705 pat45">8月1日-8月15日：您本次共有<span class="banner072706"><{$num}></span>个开奖码</p>
                                    <div class="banner072707">
                                        <p class="banner072708">
                                    ...
                                    <if condition="$nowtimes egt 1502812800">
                                        <p class="banner072705 pat45">8月16日-8月31日：您本次共有<span class="banner072706_1"><{$num1}></span>个开奖码</p>
                                        <div class="banner072709">
                                            <p class="banner072710">
                                                <if condition="$num1!=0"><{$info1}>
                                                    <else />
                                                    很遗憾，您暂时未有中奖号码
                                                </if>
                                            </p>
                                ...
                                <img src="/mall/Public/Cn/images/bannerxq/2017072703.jpg"  class="pat147" />
                                <img src="/mall/Public/Cn/images/bannerxq/2017072704.jpg"  />
                                <div class="banner072711">
                                    <a class="banner072712" href="/?user&q=code/users/hongbao"></a> 
                                </div>
                            </div>  
                        </div> -->         
                    </div>
