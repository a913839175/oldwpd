    ...
    <head>
        <meta charset="utf-8">
            <title>微拍贷</title>
                ...
                <link rel="stylesheet" href="/mall/Public/Cn/css/bannerxq.css?v=20171028"/>
                </head>
                <script>
                ...
                <body>
                    ...
                    <div class="jifen_index" style="">
                        <div class="banner0727 banner07102601">
                        ...
                        <div class="banner0727 banner07102602">
                            <div class="banner0727 banner07102603">
                                <div class="banner07102604">
                                    <img src="/mall/Public/Cn/images/bannerxq/201710260104.png" alt="" />
                                    <empty name="Think.session.k_user">
                                    <div class="banner07102605">
                                        <!-- 登录后 -->
                                        <p class="banner07102606">11月1日—11月30日：您本次共有0个开奖码</p> 
                                        <img src="/mall/Public/Cn/images/bannerxq/201710260118.png" class="zwsj" />       
                                    </div>   
                                    <else />
                                    <div class="banner07102605">
                                        <!-- 登录后 -->
                                        <p class="banner07102606">11月1日—11月30日：您本次共有<{$num}>个开奖码</p>
                                        <p class="banner07102607">
                                            <if condition="$num!=0"><{$info}>
                                                <else />
                                                <p class="banner07102615">暂无数据</p>
                                            </if></p>
                                        
                                    </div>
                                    </empty>
                                    <img src="/mall/Public/Cn/images/bannerxq/201710260105.png" alt="" />
                                    <img src="/mall/Public/Cn/images/bannerxq/201710260107.png" class="banner07102608" />
                                    <img src="/mall/Public/Cn/images/bannerxq/201710260108.png" class="banner07102609" />
                                </div>
                            </div>
                        </div>
                        <div class="banner0727 banner07102610"></div>
                        <img src="/mall/Public/Cn/images/bannerxq/201710260110.png" class="banner07102611" />
                        <img src="/mall/Public/Cn/images/bannerxq/201710260111.png" class="banner07102614" />
                    </div>
