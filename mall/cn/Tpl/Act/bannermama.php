            ...
            <link rel="stylesheet" type="text/css" href="/mall/Public/Cn/css/index.css">
                ...
                <body>
                    ...
                    <div class="jifen_index" style="width: 100%;display: block;overflow: hidden;">
                        ...
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner051201.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 491px;width: 1920px;">
                            <a href="" target="_blank" style="width:1000px;height: 1010px;display: block;margin: 0 auto;"></a>
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner051202.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 492px;width: 1920px;">
                           
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner051203.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 491px;width: 1920px;">
                            
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner051204.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 492px;width: 1920px;">
                            <p style="width: 1000px;height: 492px;margin: 0 auto;position: relative;">
                                <a href="/mall/index.php?m=index&a=index" target="_blank" style="width:176px;height: 49px;display: block;position: absolute;left: 413px;top: 61px;"></a>
                            </p>
                        </div>
                        <div style="background: url(/mall/Public/Cn/images/bannerxq/banner051205.jpg) no-repeat;clear:both;margin: 0 auto;padding: 0;left: 50%;margin-left: -960px;position: relative;height: 491px;width: 1920px;">
                             <p style="width: 1000px;height: 491px;margin: 0 auto;position: relative;">
                                <a href="/?user&q=code/users/hongbao" target="_blank" style="width:176px;height: 49px;display: block;position: absolute;left: 413px;top: 237px;"></a>
                            </p>
                        </div>
                    </div>
