...
<script type="text/javascript">
    ...
    $(function() {
      ...
      'onUploadSuccess' : function(file, data, response) { //每次成功上传后执行的回调函数，从服务端返回数据到前端
        ...
        var json = eval("("+data+")");
        i++;
        $(".image").append('<span class="i_del_'+json.imgid+'"><img src="__PUBLIC__/Uploads/Product/s_'+json.savename+'" /><a class="del_a" href="javascript:;" onclick="Del_id('+json.imgid+')"><img src="__PUBLIC__/Images/cancel.png" width="16" height="16" class="img_ico" style=" width:16px; height:16px;"></a>&nbsp;&nbsp;&nbsp;&nbsp;</span>');
      },
	...
	<div>
        ...
        <div style="width:74.8%; float:left;height:500px;" class="image">
          <foreach name="imagedata" item="vo">
            <span class="i_del_<{$vo.id}>"><img src="__PUBLIC__/Uploads/Product/<{$vo.thumb_img2}>" /><a class="del_a" href="javascript:;" onclick="Del_id(<{$vo.id}>)"><img src="__PUBLIC__/Images/cancel.png" width="16" height="16" class="img_ico" style=" width:16px; height:16px;"></a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
          </foreach>
        </div>
