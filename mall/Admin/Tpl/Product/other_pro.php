...
<script language="javascript">
	$(function(){
        ...
        win.$("#xiangguan_pro").append("<span>"+str2+"</span>");
        var parent_val = win.$("#otherpro").val();
        if(parent_val!=""){
          win.$("#otherpro").val(str+','+parent_val);
        }else{
          win.$("#otherpro").val(str+parent_val);
        }
...
<body>
	<div>
		...
		<div style="width:20%; float:left;  height:750px;">
			<foreach name="dataclass" item="vo">
                ...
                <if condition="$vo.bool eq 0">
                	<a href="<{:U('Product/other_pro',array('cid'=>$vo[id]))}>"><{$vo.proclassname}></a>
                <else />
                	<{$vo.proclassname}>
                </if>
             	 <br />
        ...
        <div style="width:79.8%; float:left;  height:750px;">
        	<div align="left">
            	<form name="form1" action="<{:U('Product/other_pro')}>" method="post">
                  ...
                  <table width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <td width="333" align="left">产品名称</td>
                    ...
                    <tbody>
                      <volist name="datapro" id="vo">
                        <tr>
                          <td align="center"><input type="checkbox" name="check[]" value="<{$vo.proname}>" dataid="<{$vo.id}>" /></td>
                          <td align="left"><{$vo.proname}></td>
