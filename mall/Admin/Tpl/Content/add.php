...
<div class="wrap J_check_wrap">
  ...
  <ul class="cc">
        ...
        <li><a href='<{:U("Content/add")}>'>添加新闻</a></li>
      </ul>
	</div>
  ...
  <form name="myform" action="<{:U("Content/add")}>" method="post" class="J_ajaxForm" enctype="multipart/form-data">
    ...
    <table width="100%" class="table_form contentWrap">
        ...
        <tr>
        	<th>发布日期</th>
        	<td>
            	<input type="text" name="showdate" id="showdate" value='<?=date("Y-m-d H:i:s",time());?>' class="input" size="30" placeholder="点击选择日期：" onclick="isdate()"/>
