...
<div class="wrap J_check_wrap">
  ...
  <div class="table_list">
    ...
    <div class="h_a">添加关键词</div>

  <form name="myform" action="<{:U("Seoset/keywords")}>" method="post" class="J_ajaxForm" enctype="multipart/form-data">
    ...
    <table width="100%" class="table_form contentWrap">
        <tbody>
                  ...
                  <tr>
                    <th width="100">关键词</th>
                    <td>
                        <input type="text" class="input key_name" name="key_name" size="40" value=""  placeholder="请输入关键字"/>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <th width="100">URL</th>
                    <td>
                        <input type="text" class="input key_url" name="key_url" value="" size="40" placeholder="请输入URL地址" />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="text" class="input match_num" name="match_num" value="3" />
                    </td>
                  </tr>
                   <tr>
                    <th width="100"></th>
                    <td>
                        <input type="checkbox" name="no_follow" value="1" />No Follow&nbsp;&nbsp;&nbsp;

                        <input type="checkbox" name="new_window" value="1" checked="checked" />新窗口打开 &nbsp;&nbsp;&nbsp;
                    </td>
                  </tr>
