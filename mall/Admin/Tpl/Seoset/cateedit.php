...
<div class="wrap J_check_wrap">
  ...
  <ul class="cc">
        ...
        <li><a href='javascript:void(0)'>栏目修改</a></li>
      </ul>
	</div>
  <div class="h_a">栏目内容</div>
  <form name="myform" action="<{:U('Seoset/cateedit')}>" method="post" class="J_ajaxForm" enctype="multipart/form-data">
    ...
    <table width="100%" class="table_form contentWrap">
        ...
        <tr>
          ...
          <td><input type="text" name="catename" value="<{$data.catename}>" class="input input_hd J_title_color" id="catename" size="70" placeholder="输入栏目名称">&nbsp;<font color="#FF0000">*</font></td>
        </tr>
         
        <tr>
          <th width="100">对应URL</th>
          <td><input type="text" name="url"  class="input" id="url" value="<{$data.url}>" size="70" placeholder="输入URL地址">&nbsp;<font color="#FF0000">*</font></td>
        </tr>
         <tr>
          <th width="100">模块名</th>
          <td><input type="text" name="module_name"  class="input" value="<{$data.module_name}>" id="module_name" size="70" placeholder="输入模块名">&nbsp;<font color="#FF0000">*</font></td>
        </tr>
        <tr>
          <th width="100">对应规则</th>
          <td><input type="text" name="rules"  class="input" id="rules" size="70" placeholder="输入规则" value="<{$data.rules}>">&nbsp;<font color="#FF0000">*</font></td>
        </tr>
        <tr>
     ...
     <div class="btn_wrap" style="z-index:999;">
      <div class="btn_wrap_pd">             
        <button class="btn btn_submit mr10 J_ajax_submit_btn" type="submit"  name="submit1">保存</button>
