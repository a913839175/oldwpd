...
<div class="wrap J_check_wrap">
  ...
  <ul class="cc">
        ...
        <li><a href='<{:U("Atlasclas/pclist")}>'>图册分类列表</a></li>
      </ul>
	</div>
    <div class="mb10">
        <a href='<{:U("Atlasclas/add")}>' class="btn" title="添加图册分类" target=""><span class="add"></span>添加图册分类</a>
  </div>
  ...
  <table width="100%" cellspacing="0" >
    ...
    <volist name="data" id="vo">
      <tr>
        ...
        <td align='center'><a href="<{:U("Atlasclas/edit",array("id"=>$vo['id']))}>">修改</a> | 
        
         <if condition="$vo.isshow eq 1">
        <font color="green"><a href='<{:U("Atlasclas/isshow",array("id"=>$vo[id],"isshow"=>0))}>'>隐藏</a></font> |
        <else />
        <a style="color:red;" href='<{:U("Atlasclas/isshow",array("id"=>$vo[id],"isshow"=>1))}>'>显示</a> |
        </if>
        
        <a onclick="return ab()" class="J_ajax_del" href="<{:U('Atlasclas/delete',array('id'=>$vo['id']) ) }>">删除</a> </td>
      </tr>
    </volist>
    </tbody>
  </table>
