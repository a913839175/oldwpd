...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="<{:U("Atlasclas/edit")}>" method="post" class="J_ajaxForm" enctype="multipart/form-data">
    <div class="table_full"> 
    <table width="100%" class="table_form contentWrap">
        <tbody>
        <tr>
          <th width="100">分类名称&nbsp;&nbsp;<font color="#FF0000">*</font></th>
          <td><input type="text" name="atlclassname" value="<{$data.atlclassname}>" class="input" id="atlclassname" size="30" placeholder="分类名称">&nbsp;</td>
        </tr>
        ...
        <tr>
          <th>备注</th>
          <td><textarea name="atlclasscontent"  class="inputtext" style=" width:450px;height:100px;" placeholder="该分类的其他信息："><{$data.atlclasscontent}></textarea></td>
        </tr>
      </tbody></table>
    </div>
...
<script language="javascript">
	$(function(){
		var pic = "<{$data.pic}>";
		if(pic!=""){
			$("#loading4").attr("src","__PUBLIC__/Uploads/Atlclass/"+pic);
		}
	})
</script>